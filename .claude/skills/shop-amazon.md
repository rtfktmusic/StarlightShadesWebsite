---
name: shop-amazon
description: Browse and purchase items on Amazon.au via Chrome DevTools MCP. Use when the user asks to find, compare, or buy products on Amazon.
scripts: []
---
...
Navigate to cart: `https://www.amazon.au/gp/cart/view.html`
...
- Amazon.au is the target site (user is in Calgary, Canada)
